...
function vvv_memcached_setup() {
  ...
  vvv_info " * Copying /srv/provision/utilities/memcached/config/memcached.conf"
  cp -f "/srv/provision/utilities/memcached/config/memcached.conf" "/etc/memcached.conf"
  cp -f "/srv/provision/utilities/memcached/config/memcached.conf" "/etc/memcached_default.conf"
}
